 ...
 * @author Rui Varela
 */
public class passarSaldo extends javax.swing.JFrame {

    /**
     * Creates new form passarSaldo
     */
    public passarSaldo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Id do que vai transferir");

        jLabel3.setFont(new java.awt.Font("Tahoma", 2, 12)); // NOI18N
        jLabel3.setText("Saldo que vai transferir");
        ...
        jLabel4.setText("Id do que vai receber ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(passarSaldo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new passarSaldo().setVisible(true);
            }
        });
    }
