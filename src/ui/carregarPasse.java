 ...
 * @author Rui Varela
 */
public class carregarPasse extends javax.swing.JFrame {

    /**
     * Creates new form carregarPasse
     */
    public carregarPasse() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Carregar Passe");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(carregarPasse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new carregarPasse().setVisible(true);
            }
        });
    }
