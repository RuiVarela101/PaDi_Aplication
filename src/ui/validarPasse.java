 ...
 * @author Rui Varela
 */
public class validarPasse extends javax.swing.JFrame {

    /**
     * Creates new form validarPasse
     */
    public validarPasse() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(validarPasse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new validarPasse().setVisible(true);
            }
        });
    }
