...
public class Passes{
    private final ArrayList <Epass> passes = new ArrayList<>();
    private static long numeroCodigos = 0;

    public void alterarPasse(long codigo){
        if (validarPasse(codigo)){
            for (Epass passe : this.passes){
    ...
    public <P extends Epass> void adicionarPasse(P passe){
